...
import { Box, CradContent, CardMedia, Typography, CardContent} from '@mui/material';
...
export const ChannelCard = ({channelDetail}) => {
  ...
  >
    <Link to={`/channel/${channelDetail?.id?.channelId}`}>
        <CardContent sx ={{ disply:'flex', flexDirection: 'column', justifyContent:'center', textAlign:'center', color: '#fff'}}>
